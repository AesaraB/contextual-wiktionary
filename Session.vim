...
silent only
cd ~/Code/Context-menu-dictionary
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 popup/popup.js
badd +0 popup/popup.css
argglobal
silent! argdel *
argadd .
set stal=2
...
silent! normal! zE
let s:l = 69 - ((38 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
normal! 0217|
lcd ~/Code/Context-menu-dictionary
tabedit ~/Code/Context-menu-dictionary/popup/popup.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
